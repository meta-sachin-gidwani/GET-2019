...
INSERT INTO product(name, quantity, price, date,category_id,image) VALUES
    ...
    ('Redmi 3s Prime', 10, 9000.00, '2016/07/01',4,'Image1.png'),
    ('Redmi Note 4', 50, 12499.99, '2017/08/01',4,'redminote4.jpg'),
    ('Redmi Note 4', 50, 12499.99, '2017/08/01',4,'redminote4(2).jpg'),
    ('Dell Inspiron 4Ti6xy', 25, 40000.00, '2018/07/01',5,'dellInspiron.png'),
    ('Sony Vostro Glide', 35, 90399.99, '2017/01/01',5,'sony.jpg'),
    ('Dell Inspiron 5Ti3fa', 5, 50000.00, '2017/09/23',5,'dellInspiron.jpg'),
